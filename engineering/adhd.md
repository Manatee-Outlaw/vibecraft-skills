...
If the user typed `/adhd`, explicitly asked for ADHD mode ("use the adhd
skill", "run ADHD on this"), or used an open-ended ideation phrase
("brainstorm", "let's figure out", "help me think through", "explore
options", "what are my options", "ideate"), **SKIP the rest of this section
and go straight to Phase 1**. The user opted in. Do not second-guess.
